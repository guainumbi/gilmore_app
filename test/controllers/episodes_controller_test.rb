...
class EpisodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post episodes_url, params: { episode: { aired_at: @episode.aired_at, season_id: @episode.season_id, title: @episode.title } }
    end
  ...
  test "should update episode" do
    patch episode_url(@episode), params: { episode: { aired_at: @episode.aired_at, season_id: @episode.season_id, title: @episode.title } }
